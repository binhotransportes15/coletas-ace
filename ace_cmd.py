...
def cmd_help() -> str:
    return "\n".join(
        [
            ...
            "                Setores e tempos: Menu → Automação.",
            ...
            "  Tema do CRT: fixo (Circuitos). Só a logo das dashboards muda",
            "  em Menu → Configuração.",
            "",
            "────────────────────────────────────",
            ...
            "TV / PAREDE",
            "────────────────────────────────────",
            "  Menu → TV     Editor da parede (setores por TV, logo, margens).",
