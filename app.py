...
class MainWindow(QMainWindow):
    ...
    def _build_menu(self) -> None:
        ...
        action_dash = QAction("Abrir Distribuição (dashboard)", self)
        action_dash.triggered.connect(self._open_dashboard)
        action_dash_tv = QAction("Abrir Distribuição em modo TV", self)
    ...
    def _build_tab50(self, root: QVBoxLayout) -> None:
        ...
        self.open_dash_button = QPushButton("Distribuição (dashboard)")
        self.open_dash_button.setToolTip("Abre a tela unificada ENTREGA + COLETA")
